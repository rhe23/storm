...
/**
 * Default interface to map a {@link org.apache.storm.cassandra.bolt.ITuple} to a CQL {@link com.datastax.driver.core.Statement}.
 */
...
public interface CQLStatementTupleMapper extends Serializable {
     ...
     */
    List<Statement> map(Map<String, Object> conf, Session session, Tuple tuple);
    ...
    class DynamicCQLStatementTupleMapper implements CQLStatementTupleMapper {
        ...
        @Override
        public List<Statement> map(Map<String, Object> conf, Session session, Tuple tuple) {
