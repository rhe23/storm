 ...
 *
 * <p>Default {@link org.apache.storm.cassandra.bolt.BaseTickTupleAwareRichBolt}
 */
public abstract class BaseCassandraBolt<T> extends BaseTickTupleAwareRichBolt {
     ...
     */
    @Override
    public void prepare(Map topoConfig, TopologyContext topologyContext, OutputCollector outputCollector) {
